...
export const Apps = () => {
  return (
    <div className="bg-sky-300 md:h-[450px] h-[800px] md:w-full w-full flex flex-col  gap-4 items-center justify-evenly">
      <button className="h-7 w-[75px] bg-blue-300 rounded-2xl shadow-2xl">
        Skills
      </button>
      ...
      <div>
        <div className="grid grid-cols-3  w-[334px] md:grid-cols-8 md:w-[1216px] gap-2 place-items-center md:place-content-between">
